for(let i = 0; i < document.querySelectorAll('.drum').length; i++) {
    var buttonW = document.querySelectorAll('.drum')[i].addEventListener('click', function() {
        ...
        ButtonClickAnimation(buttonclick);
...
function ButtonClickAnimation(CurrentKey) {
    ...
    // setTimeout() é um método para fazer algo depois de um tempo determinado tempo.
    // setTomeout(function, milliseconds, paramentro 1, paramentro 2);
}